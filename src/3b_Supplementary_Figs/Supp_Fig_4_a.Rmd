...
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC1.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC1)
...
UMAP <- ggplot(pD.HMC2, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC2.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC2)
...
UMAP <- ggplot(pD.HMC3, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC3.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC3)
...
UMAP <- ggplot(pD.HMC4, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC4.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC4)
...
UMAP <- ggplot(pD.HMC2B, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC2B.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC2B)
...
UMAP <- ggplot(pD.HMC5, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC5.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC5)
...
UMAP <- ggplot(pD.HMC6, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC6.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC6)
...
UMAP <- ggplot(pD.HMC7, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC7.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC7)
...
UMAP <- ggplot(pD.HMC8, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC8.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC8)
...
UMAP <- ggplot(pD.HMC9, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_HMC9.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.HMC9)
```
...
UMAP <- ggplot(pD.RB1, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_RB1.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.RB1)
...
UMAP <- ggplot(pD.RB2, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_RB2.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.RB2)
...
UMAP <- ggplot(pD.RB3, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_RB3.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.RB3)
...
UMAP <- ggplot(pD.RB4, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_RB4.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.RB4)
...
UMAP <- ggplot(pD.RB5, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_RB5.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.RB5)
...
UMAP <- ggplot(pD.RB6, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_RB6.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.RB6)
...
UMAP <- ggplot(pD.RB7, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_RB7.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.RB7)
...
UMAP <- ggplot(pD.RB8, mapping=aes(x=UMAP1, y=UMAP2, color=Sample)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/Downstream_graphs/Samples/Umap_sample_RB8.pdf", width=10, height=8)
UMAP
dev.off()
rm(pD.RB8)
```