...
```
**Supp_Fig_11**
*Making chord plots for the most interesting cell-cell communications*
```{r}
...
```
**Supp_Fig_11**
*Making bubble plots of the most interesting genes identified in the analysis*
```{r}
...
pdf("../../data/Supp_Fig_11/Supp_Fig_11b.pdf", width=8, height=4.5)
Bubble.gene
dev.off()
