...
Number of cells from each sample per cluster
```{r}
...
write.csv(sumry,file="../../data/Downstream_graphs/SummaryStatistics.csv",row.names=FALSE)
```
...
write.csv(sumry,file="../../data/Downstream_graphs/SummaryStatistics_bySample.csv",row.names=FALSE)
```