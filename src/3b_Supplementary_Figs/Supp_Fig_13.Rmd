...
write.csv(markers$Luminal_LP,"../../data/Supp_Fig_13/CellSignatures/DEGs_LPvsAllCellTypes.csv")
write.csv(markers$Luminal_HMC1,"../../data/Supp_Fig_13/CellSignatures/DEGs_LC1vsAllCellTypes.csv")
write.csv(markers$Luminal_HMC2,"../../data/Supp_Fig_13/CellSignatures/DEGs_LC2vsAllCellTypes.csv")
write.csv(markers$Basal,"../../data/Supp_Fig_13/CellSignatures/DEGs_BAvsAllCellTypes.csv")
write.csv(markers$Luminal_HR,"../../data/Supp_Fig_13/CellSignatures/DEGs_HRvsAllCellTypes.csv")
write.csv(markers$Stroma,"../../data/Supp_Fig_13/CellSignatures/DEGs_STvsAllCellTypes.csv")
...
write.csv(LP.genes,"../../data/Supp_Fig_13/CellSignatures/LP_Signature.csv")
write.csv(LC1.genes,"../../data/Supp_Fig_13/CellSignatures/LC1_Signature.csv")
write.csv(LC2.genes,"../../data/Supp_Fig_13/CellSignatures/LC2_Signature.csv")
write.csv(BA.genes,"../../data/Supp_Fig_13/CellSignatures/BA_Signature.csv")
write.csv(HR.genes,"../../data/Supp_Fig_13/CellSignatures/HR_Signature.csv")
write.csv(ST.genes,"../../data/Supp_Fig_13/CellSignatures/ST_Signature.csv")

write.csv(LC1.geneswithLP,"../../data/Supp_Fig_13/CellSignatures/LC1_Signature_withLP.csv")
write.csv(LC2.geneswithLP,"../../data/Supp_Fig_13/CellSignatures/LC2_Signature_withLP.csv")
```
...
pdf("../../data/Supp_Fig_13/Supp_Fig_13_ai.pdf", width=10, height=6)
Basal
dev.off()
```
*Replotting My LP scores*
```{r}
...
pdf("../../data/Supp_Fig_13/Supp_Fig_13_aiv.pdf", width=10, height=6)
LP
dev.off()
```
*Replotting My HR scores*
```{r}
...
pdf("../../data/Supp_Fig_13/Supp_Fig_13_aiii.pdf", width=10, height=6)
HR
dev.off()
```
...
pdf("../../data/Supp_Fig_13/Supp_Fig_13_aii.pdf", width=10, height=6)
Strom 
dev.off()
```
*Replotting My LC1 scores*
```{r}
...
pdf("../../data/Supp_Fig_13/Supp_Fig_13_av.pdf", width=10, height=6)
LC1
dev.off()
```
*Replotting My LC2 scores*
```{r}
...
pdf("../../data/Supp_Fig_13/Supp_Fig_13_avi.pdf", width=10, height=6)
LC2
dev.off()
```
...
pdf("../../data/Supp_Fig_13/Supp_Fig_13_bi.pdf", width=10, height=6)
LC1
dev.off()
```
*Replotting My LC2 scores*
...
pdf("../../data/Supp_Fig_13/Supp_Fig_13_bii.pdf", width=10, height=6)
LC2
dev.off()
```
**Saving session info**
