...
```
**Supp_Fig_6**
*Heatmap of key characteristic genes from the milk cell literature*
```{r}
set.seed(300)
...
ggsave(filename="../../data/Supp_Fig_6/Heatmap_stem_ClusterSignatures.pdf",h[[4]],width=8,height=5)
