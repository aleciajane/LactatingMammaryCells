...
q
ggsave(filename="../../data/RB_HMC_merged/Supp_Fig_7/Fig_7cii.pdf",width=6,height=3)
```
**Supp Fig 7cii**
*GO term analysis of downregulated genes with biological process*
```{r}
...
q
ggsave(filename="../../data/Supp_Fig_7/Fig_7ci.pdf",width=9,height=3)
```
*Saving session info*
```{r}
sessionInfo()
