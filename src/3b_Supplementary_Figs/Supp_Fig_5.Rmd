...
```
**Supp_Fig_5**
*Plotting individual PCA for each sample*
Subsetting by Sample then running PCA
...
PCAs.ident 
pdf("../../data/Supp_Fig_5/PCA_1_2_HMC1_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*LMC2*
...
PCAs.ident <- ggcells(sce.hvg.sub, aes(x=PCA1, y=PCA2, color=Identity))+
    ...
    scale_color_manual(values=setNames(colours.classes, classes))
PCAs.ident 
pdf("../../data/Supp_Fig_5/PCA_1_2_HMC2_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*LMC2B*
...
PCAs.ident <- ggcells(sce.hvg.sub, aes(x=PCA1, y=PCA2, color=Identity))+
    ...
    scale_color_manual(values=setNames(colours.classes, classes))
PCAs.ident 
pdf("../../data/Supp_Fig_5/PCA_1_2_HMC2B_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*LMC3*
...
PCAs.ident <- ggcells(sce.hvg.sub, aes(x=PCA1, y=PCA2, color=Identity))+
    ...
    scale_color_manual(values=setNames(colours.classes, classes))
PCAs.ident 
pdf("../../data/Supp_Fig_5/PCA_1_2_HMC3_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*LMC4*
...
PCAs.ident <- ggcells(sce.hvg.sub, aes(x=PCA1, y=PCA2, color=Identity))+
    ...
    scale_color_manual(values=setNames(colours.classes, classes))
PCAs.ident 
pdf("../../Supp_Fig_5/PCA_1_2_HMC4_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*LMC5*
...
PCAs.ident <- ggcells(sce.hvg.sub, aes(x=PCA1, y=PCA2, color=Identity))+
    ...
    scale_color_manual(values=setNames(colours.classes, classes))
PCAs.ident 
pdf("../../Supp_Fig_5/PCA_1_2_HMC5_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*LMC6*
...
PCAs.ident <- ggcells(sce.hvg.sub, aes(x=PCA1, y=PCA2, color=Identity))+
    ...
    scale_color_manual(values=setNames(colours.classes, classes))
PCAs.ident 
pdf("../../Supp_Fig_5/PCA_1_2_HMC6_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*LMC7*
...
PCAs.ident <- ggcells(sce.hvg.sub, aes(x=PCA1, y=PCA2, color=Identity))+
    ...
    scale_color_manual(values=setNames(colours.classes, classes))
PCAs.ident 
pdf("../../Supp_Fig_5/PCA_1_2_HMC7_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*LMC8*
...
PCAs.ident <- ggcells(sce.hvg.sub, aes(x=PCA1, y=PCA2, color=Identity))+
    ...
    scale_color_manual(values=setNames(colours.classes, classes))
PCAs.ident 
pdf("../../data/Supp_Fig_5/PCA_1_2_HMC8_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*HMC9*
...
PCAs.ident <- ggcells(sce.hvg.sub, aes(x=PCA1, y=PCA2, color=Identity))+
    ...
    scale_color_manual(values=setNames(colours.classes, classes))
PCAs.ident 
pdf("../../data/Supp_Fig_5/PCA_1_2_HMC9_Identity.pdf", width=6, height=4)
PCAs.ident
dev.off()
```
*Saving session info*
