...
UMAP
pdf("../../data/RB_HMC_merged/Downstream_graphs/NoSpike/UMAP_Batch_B1.pdf", width=12, height=8)
UMAP
dev.off()
...
UMAP <- ggplot(B1b, mapping=aes(x=UMAP1, y=UMAP2, color=Batches)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/RB_HMC_merged/Downstream_graphs/NoSpike/UMAP_Batch_B1b.pdf", width=12, height=8)
UMAP
dev.off()
...
UMAP <- ggplot(B2, mapping=aes(x=UMAP1, y=UMAP2, color=Batches)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/RB_HMC_merged/Downstream_graphs/NoSpike/UMAP_Batch_B2.pdf", width=12, height=8)
UMAP
dev.off()
...
UMAP <- ggplot(B3, mapping=aes(x=UMAP1, y=UMAP2, color=Batches)) + 
    ...
    panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
UMAP
pdf("../../data/RB_HMC_merged/Downstream_graphs/NoSpike/UMAP_Batch_B3.pdf", width=12, height=8)
UMAP
dev.off()
```
