...
```
*DEG analysis on HMC luminal cells and Luminal Progenitors*
```{r}
...
```
**Fig_4c**
*GO term analysis of upregulated genes_higher in LP (vs HMC)*
```{r}
...
```
*GO term analysis of downregulated genes_higher in HMC (vs LP)*
```{r}
...
```
**Fig 4d**
*Making bubble plots of selected genes*
```{r}
#mapping cell types onto sce
