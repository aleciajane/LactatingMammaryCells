...
```
**Supp_Fig_3_d_ii**
*This plot displays the number of signalling interactions between each cell type.*
```{r}
...
```
**Supp_Fig_3_d_iii**
*This plot displays interesting ligand-receptor pairs for different cell types.*
```{r}
#EGF
pathways.show <- "EGF"
