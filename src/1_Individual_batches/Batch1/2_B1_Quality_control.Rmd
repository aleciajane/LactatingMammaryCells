...
#Load data
sce <- readRDS("../../data/Batch1/sce.rds")
...
State <- c("HM", "HM", "HM", "HM", "RB", "RB", "RB", "RB")
...
color.names <- c("salmon1", "peachpuff2", "burlywood", "#F8766D", "steelblue3", "slategray3", "paleturquoise3","#00BFC4")
...
LibrarySize
pdf("../../data/Batch1/QualityControl_graphs/UMI_counts.pdf", width=12, height=8)
LibrarySize
dev.off()
...
genesDetected <- ggplot(pD, aes(x=Sample, y=detected, fill=Sample)) +
  ...
  theme_bw() + scale_fill_manual(values=setNames(color.names, sample.set))
genesDetected
pdf("../../data/Batch1/QualityControl_graphs/Gene_count.pdf", width=12, height=8)
genesDetected
dev.off()
...
UmiGeneSum
pdf("../../data/Batch1/QualityControl_graphs/UmiGeneSum_highUMI.pdf", width=12, height=8)
UmiGeneSum
dev.off()

#4. Coloured scatter plot with mitochondrial counts compared to number of genes coloured by UMI count per cell
...
cellViability
pdf("../../data/Batch1/QualityControl_graphs/Cell_viability.pdf", width=12, height=8)
cellViability
dev.off()
...
MitoUMI
pdf("../../data/Batch1/QualityControl_graphs/Mitocounts_vs_UMIs.pdf", width=12, height=8)
MitoUMI
dev.off()
```
**Filtering the data**
...
pdf("../../data/Batch1/QualityControl_graphs/Gene_count_clean.pdf", width=12, height=8)
genesDetected %+% pD.pass
dev.off()

pdf("../../data/Batch1/QualityControl_graphs/UMI_count_clean.pdf", width=12, height=8)
LibrarySize %+% pD.pass
dev.off()

pdf("../../data/Batch1/QualityControl_graphs/UmiGeneSum_clean.pdf", width=12, height=8)
UmiGeneSum %+% pD.pass
dev.off()

pdf("../../data/Batch1/QualityControl_graphs/Cell_viability_clean.pdf", width=12, height=8)
cellViability %+% pD.pass
dev.off()

pdf("../../data/Batch1/QualityControl_graphs/Mitocounts_vs_UMIs_clean.pdf", width=12, height=8)
MitoUMI %+% pD.pass
dev.off()
```
...
write.csv(sumry1, "../../data/Batch1/QualityControl_graphs/Pre-filter_summary.csv")
...
write.csv(sumry, "../../data/Batch1/QualityControl_graphs/Post-filter_summary.csv")
```
**Normalization**
...
```
*Saving the data*
Saving the new data sets that have been filtered and normalised with the new name "sce_clean.rds".
```{r}
saveRDS(sce.pass,file="../../data/Batch1/sce_clean.rds")
sessionInfo()
```